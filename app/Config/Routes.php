...
$routes->resource('SuppliersApi');


######## ROTA DE FORNECEDOR ########
$routes->get('/clientes/lista', 'ClientsController::listClients');
$routes->get('/clientes/inserir', 'ClientsController::insertClient');
$routes->get('/clientes/editar/(:any)', 'ClientsController::editClient/$1');
$routes->post('/clientes/deletar', 'ClientsController::deleteClient');
$routes->post('/clientes/salvar', 'ClientsController::save');
